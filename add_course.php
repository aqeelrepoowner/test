<?php
	...
	if(isset($_POST['confirm_add_course']))
	{
		$course = new course();
          ...
          <div class="col-lg-6">
            ...
            <form role="form" method="post" action="" onsubmit="return validateCourse();">
			  ...
			  <div class="form-group">
                ...
                <input type="text" class="form-control" name="course_name" placeholder="Enter text">
                <p class="help-block"></p>
              </div>
			  
			<div class="form-group">
                <label>Course Description</label>
                <textarea class="form-control" placeholder="Enter text" rows="3" name="course_desc"></textarea>
                <p class="help-block"></p>
              </div>
			  

			   <input type="submit" class="btn btn-default" name="confirm_add_course" value="Add Course">

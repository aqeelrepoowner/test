<?php
	...
	{	
		...
		$returnedRows = $authenticate->checkLoginDetails();
...
<body style="background:url('images/masjid.jpg') no-repeat;background-size:1400px;">
		<div class="container-fluid">
		<div class="row-fluid">
		
			<div class="row-fluid" style="width:100%;margin-right:20%;">
				<div class="span12 center login-header">
					<h1>Welcome to Darulhuda</h1>
				</div><!--/span-->
			</div><!--/row-->

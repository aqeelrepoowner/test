...
<html lang="en">
  <head>
    ...
    <title>Darul Huda - Fees Payment History</title>
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Fees Payment History<small></small></h1>
            <ol class="breadcrumb">
              <li><a href="index.html"><i class="icon-dashboard"></i> Home</a></li>
              <li class="active"><i class="icon-file-alt"></i>Fees</li>
			  <li class="active"><i class="icon-file-alt"></i>Fees Payment History</li>
            </ol>
          </div>
